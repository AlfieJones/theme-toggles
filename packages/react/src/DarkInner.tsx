    ...
    >
      ...
      >
        <path
          ...
          className={
            toggled === undefined
              ? "origin-center transition-transform duration-(--toggles-dark-inner--duration) [transition-timing-function:ease] dark:rotate-180"
              : toggled
                ? "origin-center transition-transform duration-(--toggles-dark-inner--duration) [transition-timing-function:ease] rotate-180"
