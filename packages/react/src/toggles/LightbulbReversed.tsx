import "../../../../build/lightbulb-reversed.min.css";
import React, { useState, forwardRef } from "react";
import { ToggleProps } from "../";
const SvgLightbulbReversed = forwardRef<HTMLButtonElement, ToggleProps>((props: ToggleProps, ref) => {
  const {
    onToggle,
    toggled,
    toggle,
  ...
  const btnStyle = { ...style,
    "--theme-toggle__lightbulb-reversed--duration": `${duration}ms`
  };
