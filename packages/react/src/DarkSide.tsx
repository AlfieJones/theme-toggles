...
export interface DarkSideProps extends Omit<
  ...
  return (
    ...
    >
      <svg
        ...
        fill={"currentColor"}
        style={
          { "--toggles-dark-side--duration": `${duration}ms` } as CSSProperties
        }
      >
        <path
          d={
          ...
          className={
            toggled === undefined
              ? "origin-center transition-transform duration-(--toggles-dark-side--duration) [transition-timing-function:ease] dark:rotate-180"
              : toggled
                ? "origin-center transition-transform duration-(--toggles-dark-side--duration) [transition-timing-function:ease] rotate-180"
