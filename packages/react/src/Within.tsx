      ...
      >
        ...
        <g clipPath={`url(#${clipMainId})`}>
          <path
            ...
            className="[transform-origin:center] motion-safe:[transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:scale(0.65)]"
          />
        </g>
        <path
          d={
          ...
          className="[transform-origin:center] motion-safe:[transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:scale(1.5)]"
        />
        <path
          d={
            "M16 9.5c-3.6 0-6.4 2.9-6.4 6.4s2.8 6.5 6.4 6.5 6.4-2.9 6.4-6.4-2.8-6.5-6.4-6.5z"
          }
          className="[transform-origin:center] motion-safe:[transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:translate3d(3px,-3px,0)_scale(1.2)]"
        />
      </svg>
    </button>
  );
