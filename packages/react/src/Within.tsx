      ...
      >
        ...
        <g clipPath={`url(#${clipMainId})`}>
          <path
            ...
            className={
              toggled === undefined
                ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:scale(0.65)]"
                : toggled
                  ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] [transform:scale(0.65)]"
        ...
        <path
          ...
          className={
            toggled === undefined
              ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:scale(1.5)]"
              : toggled
                ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] [transform:scale(1.5)]"
                : "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)]"
          }
        />
        <path
          ...
          className={
            toggled === undefined
              ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] dark:[transform:translate3d(3px,-3px,0)_scale(1.2)]"
              : toggled
                ? "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)] [transform:translate3d(3px,-3px,0)_scale(1.2)]"
                : "[transform-origin:center] [transition:transform_var(--toggles-within--duration)_cubic-bezier(0,0,0,1.25)]"
          }
        />
      </svg>
