    ...
    >
      ...
      >
        <path
          ...
          className="origin-center motion-safe:transition-transform motion-safe:duration-(--toggles-half-sun--duration) motion-safe:[transition-timing-function:ease] dark:rotate-180"
        />
      </svg>
    </button>
  );
