      ...
      >
        ...
        <g clipPath={`url(#${clipMainId})`}>
          <path
            ...
            className="motion-safe:transition-transform motion-safe:duration-(--toggles-horizon--duration) motion-safe:[transition-timing-function:cubic-bezier(0,0,0.15,1)] dark:translate-y-[50%]"
          />
        </g>
      </svg>
    </button>
