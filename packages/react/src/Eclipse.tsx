            ...
            <path
              ...
              className={
                toggled === undefined
                  ...
                  : toggled
                    ? "origin-center transition-[d,translate] [transition-duration:var(--toggles-eclipse--duration)] [transition-timing-function:cubic-bezier(0,0,0.05,1.15)] [transition-delay:0s] [d:path('M-16_-16h64v64h-64zm22_32a1_1_0_0020_0_1_1_0_00-20_0')] not-supports-[d:path('M0_0')]:-translate-x-[32px] [transition-duration:calc(var(--toggles-eclipse--duration)_*_0.8)] [transition-delay:calc(var(--toggles-eclipse--duration)_*_0.2)]"
