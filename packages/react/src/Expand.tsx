      ...
      >
            ...
            <path
              ...
              className={
                toggled === undefined
                  ...
                  : toggled
                    ? "transition-[d,translate] [transition-duration:calc(var(--toggles-expand--duration)_*_0.6)] [transition-timing-function:cubic-bezier(0,0,0.5,1)] [transition-delay:0s] [d:path('M0_0h15A1_1_0_0032_15v17H0Z')] not-supports-[d:path('M0_0')]:-translate-x-[5px] not-supports-[d:path('M0_0')]:translate-y-[11px] [transition-timing-function:cubic-bezier(0,0,0,1.25)] [transition-delay:calc(var(--toggles-expand--duration)_*_0.4)]"
        ...
        <g clipPath={`url(#${clipMainId})`}>
          <circle
            ...
            className={
              toggled === undefined
                ? "[transform-origin:center] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)_calc(var(--toggles-expand--duration)_*_0.35)] dark:[transform:scale(1.6)] dark:[transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)]"
                : toggled
                  ? "[transform-origin:center] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)_calc(var(--toggles-expand--duration)_*_0.35)] [transform:scale(1.6)] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)]"
          ...
          <path
            ...
            className={
              toggled === undefined
                ? "[transform-origin:center] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)_calc(var(--toggles-expand--duration)_*_0.35)] dark:[transform:scale(0.75)] dark:[transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)]"
                : toggled
                  ? "[transform-origin:center] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)_calc(var(--toggles-expand--duration)_*_0.35)] [transform:scale(0.75)] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)]"
                  : "[transform-origin:center] [transition:transform_calc(var(--toggles-expand--duration)_*_0.65)_cubic-bezier(0,0,0,1.25)_calc(var(--toggles-expand--duration)_*_0.35)]"
            }
          />
        </g>
