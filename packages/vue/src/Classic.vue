    ...
    >
      ...
      <g :stroke="'currentColor'" :stroke-linecap="'round'">
        <circle
          ...
          :class="'origin-center transition-transform duration-(--toggles-dot-dev--duration) dark:scale-170'"
        />
        <path
          :d="'M12 1.4v2.4'"
          :fill="'none'"
          ...
          :class="'[transform-box:view-box] [transform-origin:center] [transition:transform_var(--toggles-dot-dev--duration),opacity_var(--toggles-dot-dev--duration)] delay-[calc(var(--toggles-dot-dev--duration)*0.15)] dark:delay-0 dark:[transform:scale(0)] dark:opacity-0'"
        />
        <path
          :d="'m20.3 3.7-2.5 2.5'"
          :fill="'none'"
