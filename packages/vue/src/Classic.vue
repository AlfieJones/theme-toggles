    ...
    >
      ...
      <g :stroke="'currentColor'" :stroke-linecap="'round'">
        ...
        <path
          ...
          :class="'origin-center transition-[transform,opacity] duration-(--toggles-dot-dev--duration) delay-[calc(var(--toggles-dot-dev--duration)*0.15)] dark:delay-0 dark:scale-50 dark:rotate-45 dark:opacity-0'"
        />
        <path
          :d="'m20.3 3.7-2.5 2.5'"
          :fill="'none'"
