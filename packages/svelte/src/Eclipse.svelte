  ...
  >
    ...
    <g clip-path={`url(#${clipMainId})`}>
      <circle
        ...
        cy={16}
        r={16}
        class={"[transform-origin:center] [transition-property:transform] [transition-duration:var(--toggles-eclipse--duration)] [transition-timing-function:cubic-bezier(0,0,0.05,1.15)] dark:[transform:scale(1.6)]"}
      />
    </g>
  </svg>
</button>
