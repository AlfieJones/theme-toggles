...
<CodeGroup title="Request"  >
    ...
    ```
    ```html {{ title: 'unpkg' }}
    <script src="https://unpkg.com/@theme-toggles/core"></script>
    ```
    ```html {{ title: 'cdnjs' }}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/@theme-toggles/core/1.0.0/theme-toggles.min.js"></script>
    ```
